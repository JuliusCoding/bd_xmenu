...
RegisterNUICallback('seil', function(data, cb)
    ...
    if closestPlayer == -1 or closestDistance > 1.0 then
        TriggerEvent("juliusnotify", "#40fdfe", "INFO", "Keine Spieler in der Nähe!")
            ...
            TriggerServerEvent('juliusfesseln:rope', GetPlayerServerId(closestPlayer))
    end
end)
...
RegisterNUICallback('autoschlussel', function(data, cb)
    ...
    if #cars == 0 then
        ...
        for i=1, #carstrie, 1 do
            ...
            ESX.TriggerServerCallback('juliusxmenu:isVehicleOwner', function(owner)
...
RegisterNUICallback('suchen', function(data, cb)
    ...
    if closestPlayer == -1 or closestDistance > 1.0 then
        ...
        TriggerServerEvent('juliusfesseln:search', GetPlayerServerId(closestPlayer))
    end
end)
